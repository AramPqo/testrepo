...
export class PatientService {
  ...
  patientsWithAppointments(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IPatient[]>(SERVER_API_URL + 'api/patientsWithAppointments', { params: options, observe: 'response' })
