...
import com.novanus.medappoint.repository.CountryRepository;
import com.novanus.medappoint.service.CountryService;
import com.novanus.medappoint.service.dto.CountryDTO;
import com.novanus.medappoint.service.mapper.CountryMapper;
...
public class CountryResourceIT {
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc&name=" + country.getName()))
        ...
        // no matches
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc&name=countryNotFound"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
