...
@Injectable({ providedIn: 'root' })
class ExpenseBusinessResolve implements Resolve<IBusiness[] | null> {
  constructor(private service: BusinessService) { }
  resolve() {
    return this.service.query().pipe(map((insurers: HttpResponse<IBusiness[]>) => insurers.body));
  }
}
...
export const expenseRoute: Routes = [
  {
    ...
    data: {
      ...
      pageTitle: 'medappointApp.expense.home.title',
    },
    resolve: {
      business: ExpenseBusinessResolve
    },
